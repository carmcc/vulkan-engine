...
namespace ve {
    ...
    void VePipeline::createGraphicsPipeline(const string &vertFilePath, const string &fragFilePath, const PipelineConfigInfo &configInfo){
        ...
        shaderStages[1].stage = VK_SHADER_STAGE_FRAGMENT_BIT; //fragment shader
        ...
        pipelineInfo.pInputAssemblyState = &configInfo.inputAssemblyInfo; //input assembly
        pipelineInfo.pViewportState = &configInfo.viewportInfo; //viewport and scissor
        pipelineInfo.pRasterizationState = &configInfo.rasterizationInfo; //rasterization
        pipelineInfo.pMultisampleState = &configInfo.multisampleInfo; //multisample

        pipelineInfo.pDepthStencilState = &configInfo.depthStencilInfo; //depth and stencil
        pipelineInfo.pColorBlendState = &configInfo.colorBlendInfo; //color blend
        ...
        pipelineInfo.subpass = configInfo.subpass; //subpass
